              ...
              <div className="shadow-sm border-2 mt-6 p-4 rounded-md w-9/12 hover:shadow-xl">
                ...
                <div className="p-6  ">
                  <div className="flex justify-center ">
                    ...
                    <h1 className="ml-2">Meroni Inc Team</h1>
                  </div>
                  <div className="flex justify-center mt-2">
                    <img src={email} className="h-4 w-4 mt-1" alt="email"></img>
                    <h4 className="ml-2">Meroniinc@gmail.com</h4>
                  </div>
                  <div className="flex justify-center gap-10 mt-6 ">
                    <a href="https://www.instagram.com/Meronicinc/">
                      <img
                        src={admin_insta}
                        className="h-5 w-5"
                        alt="insta"
                    ...
                    <a href="https://github.com/Meroni-bcg/Meroni-Inc-Portal">
                      <img src={admin_git} className="h-5 w-5" alt="git"></img>
                    </a>
                    <a href="https://www.linkedin.com/mwlite/company/meroni-inc">
                      <img
                        src={admin_linkedin}
                        className="h-5 w-5 "
                        alt="linkedin"
